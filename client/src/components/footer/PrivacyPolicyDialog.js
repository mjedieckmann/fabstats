...
export default function PrivacyPolicyDialog() {
    ...
    return (
        <>
            <Button aria-label="privacy-policy" onClick={handlePrivacyPolicyDialogOpen}>
                Privacy Policy
            </Button>
            <Dialog
                ...
                aria-describedby="privacy-policy-dialog-content"
            >
                <DialogTitle id="privacy-policy-dialog-title">
                    Privacy Policy for fabstats
                </DialogTitle>
                <DialogContent>
                    <Stack>
                        <Typography variant="body2">At fabstats.info, accessible from <Link to={'/'}>www.fabstats.info</Link>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by fabstats.info and how we use it.</Typography>
                        ...
                        <Typography variant="body2">This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in fabstats.info. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.</Typography>
                        ...
                        <Typography variant="body2">fabstats.info follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</Typography>

                        <h2>Cookies and Web Beacons</h2>

                        <Typography variant="body2">Like any other website, fabstats.info uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</Typography>

                        <Typography variant="body2">For more general information on cookies, please read <a href="https://www.termsfeed.com/blog/sample-cookies-policy-template/#What_Are_Cookies">the Cookies article on TermsFeed website</a>.</Typography>



                        <h2>Advertising Partners Privacy Policies</h2>

                        <Typography variant="body2">You may consult this list to find the Privacy Policy for each of the advertising partners of fabstats.info.</Typography>

                        <Typography variant="body2">Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on fabstats.info, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</Typography>

                        <Typography variant="body2">Note that fabstats.info has no access to or control over these cookies that are used by third-party advertisers.</Typography>

                        <h2>Third Party Privacy Policies</h2>

                        <Typography variant="body2">fabstats.info's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Typography>
                        ...
                        <Typography variant="body2">fabstats.info does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</Typography>
                    </Stack>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handlePrivacyPolicyDialogClose}>OK</Button>
                </DialogActions>
            </Dialog>
        </>
    );
